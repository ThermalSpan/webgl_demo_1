/* tslint:disable */
import * as wasm from './aperture_wasm_bg';

export function update(arg0, arg1, arg2) {
    return wasm.update(arg0, arg1, arg2);
}
...
export function get_clipspace_transform() {
    const retptr = globalArgumentPtr();
    wasm.get_clipspace_transform(retptr);
...
export function handle_scroll(arg0) {
    return wasm.handle_scroll(arg0);
}
...
export function __wbindgen_Math_acos(x) { return Math.acos(x); }
